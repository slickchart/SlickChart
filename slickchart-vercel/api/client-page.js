...
// ESM has no built-in __dirname (that's a CommonJS-only global) — derive it
// from import.meta.url instead, or any reference to __dirname below throws
// "ReferenceError: __dirname is not defined" on every request.
